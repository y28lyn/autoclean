  ...
  return (
    <>
      <div className="flex flex-col-reverse md:flex-row text-left">
        <div className="p-6">
          <div className="shadow rounded relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
            ...
            <div className="shadow rounded absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
